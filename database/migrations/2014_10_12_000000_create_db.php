...
return new class extends Migration
{
    ...
    public function up()
    {
        // drop the tables first if it exists
        ...
        Schema::create('messages', function (Blueprint $table) {
            ...
            $table->datetime('appointment')->nullable(); // kuhaon diya
            $table->string('status')->check(DB::raw('status in ("active", "offline")'))->default('active'); // kuhaon man diya
