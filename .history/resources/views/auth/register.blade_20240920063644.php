...
<div class="RegisterFormContainer flex items-center justify-center h-screen">
    ...
    <form method="POST" action="{{ route('register') }}" class="mx-auto bg-brownbgcolor w-2/3 bg-opacity-80 backdrop-blur-md h-4/5 scroll-smooth snap-start snap-always rounded-md">
