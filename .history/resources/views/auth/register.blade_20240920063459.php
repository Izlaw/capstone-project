...
<body class="bg-mainbackground bg-cover overflow-y-hidden">
    ...
    <form method="POST" action="{{ route('register') }}" class="mx-auto bg-brownbgcolor w-2/3 bg-opacity-80 backdrop-blur-md h-4/5 translate-y-1/2 absolute scroll-smooth snap-start snap-always">
