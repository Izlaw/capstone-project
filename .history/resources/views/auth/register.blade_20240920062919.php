...
<body class="bg-mainbackground bg-cover overflow-y-hidden">
    ...
    <p class="RegisterTxt translate-y-6 text-center text-lg font-medium text-white mb-10">Create an account with 7 GUYS House of Shop.</p>
        ...
        <div class="RegisterFormContainer overflow-y-scroll h-65percent">
            ...
            <!-- Register button -->
            <button type="button" class="mt-6 mx-auto block bg-maroonbgcolor p-2 rounded-lg text-white hover:text-maroonbgcolor hover:bg-white py-4 transition duration-300 ease-in-out">
                {{ __('Register') }}
            </button>
        </div>

        <!-- Login redirect -->
        <button class="LoginRedirectBtn text-white mt-4 px-4 py-2 rounded-md hover:bg-white hover:text-maroonbgcolor transition duration-300 ease-in-out">
