...
Route::middleware(['auth', 'role:employee'])->group(function () {
    ...
    Route::get('/assistcustomer', [AssistCustomerController::class, 'showConversations'])->name('assistcustomer');
});
...
Route::get('/chat/{recipient}', [AssistCustomerController::class, 'showConversations'])
    ->middleware('auth')
    ->name('chat.recipient');
