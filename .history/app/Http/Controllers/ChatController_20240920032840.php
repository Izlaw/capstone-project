...
class ChatController extends Controller
{
    public function sendMessage(Request $request)
    {
        $request->validate([
            ...
            'conversation_id' => 'required|exists:conversations,conversation_id', // Validate that conversation_id exists
        ]);

        $messageContent = $request->input('message');
        $conversationId = $request->input('conversation_id'); // Get the conversation_id from the request
        ...
        $message->conversation_id = $conversationId; // Set the conversation_id
        $message->save();
        ...
        //     'date' => $message->date,
        //     'conversation_id' => $message->conversation_id, // Include conversation_id in the response for debugging
        // ]);
    }
